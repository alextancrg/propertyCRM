...
const en = {
  ...
  ai: {
    ...
    reminderTiming: "Rent alert timing (days relative to due date)",
    reminderTimingHint:
      "Positive = days after the due date · negative = days before. Alerts send when today is exactly the configured day.",
    alert1: "Alert 1",
    alert2: "Alert 2",
    alert3: "Alert 3",
    ...
    testWhatsAppTitle: "Test WhatsApp delivery",
    testWhatsAppHint:
      "Send a reminder-style message to an authorized tenant right now (bypasses the alert-day schedule) to verify Twilio outbound delivery.",
    sendTestWhatsApp: "Send test WhatsApp",
    sending: "Sending…",
    selectTenant: "Select a tenant…",
    testWhatsAppResult: "Test message to {tenant}:",
    running: "Running…",
    ...
    testDate: "Test date (optional)",
    testDateHint: "Simulate today's date to trigger the alerts without waiting.",
...
const msPatch: DeepPartial<Dictionary> = {
  ...
  ai: {
    ...
    reminderTiming: "Masa amaran sewa (hari relatif kepada tarikh akhir)",
    reminderTimingHint:
      "Positif = hari selepas tarikh akhir · negatif = hari sebelum. Amaran dihantar apabila hari ini bersamaan dengan hari yang dikonfigurasikan.",
    alert1: "Amaran 1",
    alert2: "Amaran 2",
    alert3: "Amaran 3",
    ...
    testWhatsAppTitle: "Ujian penghantaran WhatsApp",
    testWhatsAppHint:
      "Hantar mesej gaya peringatan kepada penyewa yang dibenarkan sekarang (memintas jadual hari amaran) untuk mengesahkan penghantaran keluar Twilio.",
    sendTestWhatsApp: "Hantar WhatsApp ujian",
    sending: "Menghantar…",
    selectTenant: "Pilih penyewa…",
    testWhatsAppResult: "Mesej ujian kepada {tenant}:",
    running: "Sedang berjalan…",
    ...
    testDate: "Tarikh ujian (pilihan)",
    testDateHint: "Simulasikan tarikh hari ini untuk mencetuskan amaran tanpa menunggu.",
...
const zhPatch: DeepPartial<Dictionary> = {
  ...
  ai: {
    ...
    reminderTiming: "租金提醒时间（相对到期日的天数）",
    reminderTimingHint:
      "正数 = 到期日后天数 · 负数 = 到期日前天数。当今天恰好为所配置的天数时发送提醒。",
    alert1: "提醒 1",
    alert2: "提醒 2",
    alert3: "提醒 3",
    escAfter: "自我升级（逾期天数）",
    ...
    testWhatsAppTitle: "测试 WhatsApp 发送",
    testWhatsAppHint: "立即向授权租客发送一条提醒式消息（绕过提醒日期计划），以验证 Twilio 出站发送。",
    sendTestWhatsApp: "发送测试 WhatsApp",
    sending: "发送中…",
    selectTenant: "选择租客…",
    testWhatsAppResult: "发给 {tenant} 的测试消息：",
    running: "运行中…",
    ...
    testDate: "测试日期（可选）",
    testDateHint: "模拟今天的日期以触发提醒，无需等待。",
